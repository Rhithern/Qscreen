-- Clean auth system update - handles existing policies
-- This migration safely updates the schema even if some parts already exist
...
DROP POLICY IF EXISTS "Tenant members can view jobs in their tenant" ON jobs;
DROP POLICY IF EXISTS "Employers can create jobs in their tenant" ON jobs;
DROP POLICY IF EXISTS "Job creators can update their jobs" ON jobs;
DROP POLICY IF EXISTS "Tenant members can view question bank" ON question_bank;
DROP POLICY IF EXISTS "Employers can manage question bank" ON question_bank;
DROP POLICY IF EXISTS "Tenant members can view job questions" ON job_questions;
DROP POLICY IF EXISTS "Candidates can view questions for their assigned job" ON job_questions;
DROP POLICY IF EXISTS "Employers can manage job questions" ON job_questions;
DROP POLICY IF EXISTS "Tenant members can view invites" ON invites;
DROP POLICY IF EXISTS "Employers can manage invites" ON invites;
DROP POLICY IF EXISTS "Candidates can view their own sessions" ON sessions;
DROP POLICY IF EXISTS "Candidates can update their own sessions" ON sessions;
DROP POLICY IF EXISTS "Tenant members can view sessions for jobs in their tenant" ON sessions;
DROP POLICY IF EXISTS "Candidates can manage their own responses" ON responses;
DROP POLICY IF EXISTS "Tenant members can view responses for jobs in their tenant" ON responses;
DROP POLICY IF EXISTS "Reviewers can score responses" ON responses;
DROP POLICY IF EXISTS "Tenant admins can view audit logs" ON audit_log;
